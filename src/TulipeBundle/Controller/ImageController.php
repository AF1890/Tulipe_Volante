...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $images = $em->getRepository('TulipeBundle:Image')->findAll();
    ...
    {
        $image = new Image();
        $form = $this->createForm('TulipeBundle\Form\ImageType', $image);
    ...
    {
        $deleteForm = $this->createDeleteForm($image);
        $editForm = $this->createForm('TulipeBundle\Form\ImageType', $image);
