...
use TulipeBundle\Entity\Categorie;
...
class CategorieController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('TulipeBundle\Form\CategorieType', $categorie);
    ...
    public function editAction(Request $request, Categorie $categorie)
    {
        ...
        $editForm = $this->createForm('TulipeBundle\Form\CategorieType', $categorie);
